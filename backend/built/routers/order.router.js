        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order_model_1.OrderModel.deleteOne({
                        user: req.user.id,
                        status: order_status_1.OrderStatusEnum.NEW, //if there is already an user
                    })];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, order_model_1.OrderModel.findOne({
                    user: req.user.id,
                    status: order_status_1.OrderStatusEnum.NEW,
                })];
            case 1:
                order = _a.sent();
                if (order)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                order.status = order_status_1.OrderStatusEnum.PAYED;
