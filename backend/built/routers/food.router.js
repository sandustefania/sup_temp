...
router.get("/seedNewItem", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var foodsCount;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                //   return;
                // }
                return [4 /*yield*/, food_model_1.FoodModel.create(data_1.sample_foods[foodsCount - 1])];
            case 2:
                // if (foodsCount >0) {
                //   res.send("Seed is already done");
                //   return;
